  ...
  return(
    <div className="flex justify-center">
      <form className="flex flex-col w-[40rem] h-screen mt-2">
        ...
        <button type="submit" className="border border-red rounded-md text-red mt-2 py-2 ">Delete Account</button>
        ...
        <div className="flex flex-col mt-2">
          ...
          <div className="grid grid-cols-4 place-items-center mt-4">
            <div className="col-span-1 text-green-600 text-center border border-[#bababa] w-full font-semibold py-2">Level</div>
            <div className="col-span-3 text-green-600 text-center border border-[#bababa] w-full font-semibold py-2">Subjects</div>
            {
              data.map((elem)=>{
                return(
                  <>
                    <div className="col-span-1 text-green-600 text-center border border-[#bababa] w-full font-semibold py-2">{elem.level}</div>
                    <div className="col-span-3 text-green-600 text-center border border-[#bababa] w-full font-semibold py-2">{
                      elem.subject.map((subject)=>{
                        return(
                          <p className="inline mr-2 bg-[#12774D] text-white p-2 text-sm">{subject}</p>
                        )
                      })
                      }</div>
                  </>
