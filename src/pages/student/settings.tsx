...
const StudentSettings = () => {
    ...
    return (
        <div className="w-screen  bg-[#E6E6E6] px-10 pt-10 pb-10">
        <div className="flex justify-center bg-white rounded-lg border border-[#BABABA] py-10">
            <form onSubmit={handleSubmit} className="flex flex-col w-[40rem] h-full mt-2 ">
                <p className="font-semibold text-3xl mb-2">Settings</p>
                <button type="button" className="border border-red rounded-md text-red mt-2 py-2 hover:bg-red-400 ">Delete Account
                </button>
                ...
                <div className="flex flex-col mt-2">
                    ...
                    <Link
                        ...
                        className="border text-center border-[#169962] rounded-md mt-4 text-[#169962] py-1 font-semibold h-9">Cancel
                    </Link>
                    <p>{error}</p>
                </div>
            </form>
