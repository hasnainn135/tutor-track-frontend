    ...
    <div>
      ...
      <div className="w-full h-screen flex flex-row">
        <div className="bg-white w-full lg:w-1/2 h-screen flex flex-col justify-center items-center">
          <h1 className='font-bold text-center text-4xl sm:text-6xl mb-12'>Password Reset Successfully</h1>
          <p className='text-lg text-center'>Your Password has been reset</p>
          <button type="submit" className="bg-[#169962] border w-60 sm:w-80 border-[#bababa] rounded-md mt-4 text-white py-1">Back to Login</button>
