        ...
        <div className="bg-white w-full lg:w-1/2 h-screen flex flex-col justify-center items-center ">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            ...
            <Link
              ...
              className="text-[#169962] text-right"
            >
              Forgot Password?
            </Link>
            <button
              type="submit"
              className="bg-[#169962] border w-60 sm:w-80 border-[#bababa] rounded-md mt-4 text-white py-1"
            >
              Log In
            </button>
          </form>
          <Link href="/auth/register" className="text-[#169962] mt-4">
            Create an Account
          </Link>
