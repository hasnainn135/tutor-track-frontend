...
const register = () => {
  ...
  return (
    <div className="relative w-full h-screen flex flex-row">
      ...
      <div className="bg-white w-full lg:w-1/2 h-screen flex flex-col justify-center items-center px-4">
        ...
        >
          <div className="flex flex-row w-full">
            <div className="flex flex-col mr-2 w-full">
              ...
              <input
                ...
                id="fullname"
                name="fullname"
                className="border border-[#bababa]  rounded-md mt-2 h-9 "
                required
              />
            </div>
          ...
          <button
            type="submit"
            className="bg-[#169962] border w-full h-9 border-[#bababa] rounded-md text-white py-1"
          >
            Register
          </button>

          <Link href="/auth/login" className="text-green-700 text-center block">
