  ...
  return (
    ...
    <div className="w-full h-screen flex flex-row">
      <div className="bg-white w-1/2 h-screen flex flex-col justify-center items-center">
        ...
        <p className='underline'>Didn't recieve the email?Click to send again</p>
        <p className="text-[#169962] border-2 border-[#169962] rounded-md mt-4 p-1 w-36 text-center font-bold">Back to login</p>
      </div>
...
export default verify_your_email
