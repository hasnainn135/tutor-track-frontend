  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary_green text-neutral-50 hover:bg-primary_green hover:text-neutral-50 focus:bg-primary_green focus:text-neutral-50 dark:bg-neutral-50 dark:text-primary dark:hover:bg-neutral-50 dark:hover:text-primary dark:focus:bg-neutral-50 dark:focus:text-primary",
        day_today:
